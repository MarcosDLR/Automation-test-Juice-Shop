...
class TestProduct():
        ...
        def test_product_search_finded(self, load_driver):
                ...
                assert product_page.validate_products() == True, \
                "No se encontro el producto"
                GlobalMethos.take_screenshot(load_driver, screen_module,
                                              f"{__name__}-test_product_search_finded")

        def test_product_search_image(self, load_driver):
                product_page = Product(load_driver)
                self.repetitive_steps(product_page, "Banana Juice")
                assert product_page.validate_products_image() == True, \
                "No se encontro la imagen del producto"
                GlobalMethos.take_screenshot(load_driver, screen_module,
                                              f"{__name__}-test_product_search_image")

        def test_product_search_title(self, load_driver):
                product_page = Product(load_driver)
                self.repetitive_steps(product_page,"Banana Juice")
                assert product_page.validate_products_title() == True, \
                "No se encontro la titulo del producto"
                GlobalMethos.take_screenshot(load_driver, screen_module,
                                              f"{__name__}-test_product_search_title")
        ...
        def test_product_search_finded_review(self, load_driver):
                ...
                GlobalMethos.take_screenshot(load_driver, screen_module,
                                              f"{__name__}-test_product_search_finded_review")
        ...
        def test_product_search_finded_review_empty(self, load_driver):
                ...
                GlobalMethos.take_screenshot(load_driver, screen_module,
                                              f"{__name__}-test_product_search_finded_review_empty")
