...
class TestDrawerMenu():
        ...
        def test_validate_btn_exist(self,load_driver):
                ...
                assert drawerPage.validate_btn_drawer_exist() == True, \
                "El boton del drawer no existe en la barra"

                GlobalMethos.take_screenshot(load_driver,screen_module, f"{__name__} \
                                             -test_validate_btn_exist")
